...
context('Create Test User on Live Portal', () => {
    ...
    it('1. Create a new user on Live Portal', function () {
        ...
        S.baseUrl = 'https://portal.qapro.ba/register'
      ...
      //  cy.wait(25000)
        C.emailTemplates.signUpNewUser.subject = 'Welcome to Qapro Wealth'
        ui.onboarding.verify_email_arrives_to_specified_address(D.gmailAccount, C.emailTemplates.signUpNewUser)
    })

    it('2. Subscribe to Qapro Wealth mailing list', function () {
        ui.production.open_production_url()
            .verify_production_home_page()
            .click_subscribe_button()
            .verify_hubspot_form()
            .enter_email_on_HS_form('testing+' + 'website' + currentDate + '@qapro.ba')
            .click_subscribe()
            .verify_text_is_visible('Thanks for subscribing to email updates from Qapro wealth')
    })

    it('3. Subscribe user via Investment Suitability Calculator', function () {
        S.baseUrl = 'https://qapro.ba/investment-suitability-calculator'
        ui.production.open_base_url()
            ...
            .click_OK_on_Calculator_wizard()
            .enter_email_on_last_question('testing+' + 'suitabilitycalculator' + currentDate + '@qapro.ba')
    ...
    it('4. Subscribe user via Suitability Calculator', function () {
        S.baseUrl = 'https://qapro.ba/ethical-investment-calculator'
        ui.production.open_base_url()
            ...
            .enter_Last_Name('testing')
            .click_OK_on_Calculator_wizard()
            .enter_email_on_last_question('testing+' + 'ethicalcalculator' + currentDate + '@qapro.ba')
            .click_submit_on_Calculator_wizard()
