...
context('Qapro Wealth Wordpress Site', () => {
    ...
    it('10. Check wordpress image uploaded date', function () {
        cy.visit('https://qapro.ba/wp-content/uploads/2022/12/')
