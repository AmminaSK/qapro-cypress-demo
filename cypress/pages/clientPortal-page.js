...
let
    ...
    loginToPraemiumLink = e => cy.get('[href="https://login.onpraemium.com/Qapro/"]'),
    createNewAccountLink = e => cy.get('[href="/onboarding/account-selection/593"]'),
    frequentlyAskedQLink = e => cy.get('[href="https://qapro.ba/frequently-asked-questions/#:~:text=with%20Qapro%20Wealth%3F-,EXISTING%20CLIENTS,-SUPERANNUATION%20ACCOUNTS"]'),
    formsLink = e => cy.get('[href="/client-portal/593/forms"]'),
    insightsLink = e => cy.get('[href="https://qapro.ba/content"]'),
    ...
    yourQaproPortfolioAllocationsTitle = e => cy.contains('Your Qapro Portfolio Allocations'),
    yourQaproPortfolioAllocationsTable = e => cy.get('.ant-table-container'),
    ...
    targetStrategicQaproAssetMix = e => cy.get('[style="padding-left: 12px; padding-right: 12px; text-align: center;"]'),
...
export default class LoginPage extends BasePage {
    ...
    verify_links_on_home_page() {
        ...
        this.verify_text_is_visible('Qapro Wealth Insights')
        return this;
    }
    ...
    verify_overall_asset_summary_panel(cardNumber) {
        ...
        totalAssets().should('contain.text', 'Total Assets with Qapro Wealth');
        return this;
    }
    ...
    verify_Qapro_portfolio_allocations() {
        yourQaproPortfolioAllocationsTitle().should('be.visible');
        yourQaproPortfolioAllocationsTable().should('be.visible');
        return this;
    }
    ...
    verify_performance_titles() {
        ...
        performanceTitle1().should('have.text', 'Qapro Wealth Performance Insights');
    ...
    compare_snapshots() {
        ...
        targetStrategicQaproAssetMix().compareSnapshot('target-strategic-element', {errorThreshold: 0.6});
